...
import org.wso2.carbon.solution.deployer.iam.impl.UserRoleDeployer;
import org.wso2.carbon.solution.deployer.iam.impl.UserStoreDeployer;
import org.wso2.carbon.solution.deployer.iam.impl.WorkflowDeployer;
import org.wso2.carbon.solution.deployer.iam.impl.XACMLPolicyDeployer;
...
public class IdentityServerDeployerFactory {
    ...
    private IdentityServerDeployerFactory() {
        ...
        identityServerDeployerRegistry.add(new WorkflowDeployer());
        identityServerDeployerRegistry.add(new UserRoleDeployer());
        identityServerDeployerRegistry.add(new XACMLPolicyDeployer());
    }
