...
public abstract class IdentityServerDeployer {
    ...
    public void deploy(IdentityServerArtifact identityServerArtifact, Server server)
        ...
        String outPutFilePath = ApplicationUtility.getPropertyFilePath(identityServerArtifact);
        ...
        ApplicationUtility.addToCleaningTask(outPutFilePath);
    ...
    protected abstract void cleanAll(Server server) throws CarbonSolutionException;
