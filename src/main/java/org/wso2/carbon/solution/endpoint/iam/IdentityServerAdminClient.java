...
public class IdentityServerAdminClient {
    ...
    public static IdentityProviderMgtServiceStub getIdentityProviderMgtService(Server server)
        ...
        try {
            ...
            throw new CarbonSolutionException("Error occurred while getIdentityProviderMgtService.", e);
        }
        return stub;
    }
    ...
    public static OAuthAdminServiceStub getOAuthAdminService(Server server) throws CarbonSolutionException {
        ...
        try {
            ...
            throw new CarbonSolutionException("Error occurred while getOAuthAdminService.", e);
        }
        return stub;
    }
    ...
    public static IdentitySAMLSSOConfigServiceStub getSAMLSSOConfigService(Server server)
        ...
        try {
            ...
            throw new CarbonSolutionException("Error occurred while getSAMLSSOConfigService.", e);
        }
        return stub;
    }
    ...
    public static UserStoreConfigAdminServiceStub getUserStoreConfigAdminService(Server server)
        ...
        try {
            ...
            throw new CarbonSolutionException("Error occurred while getUserStoreConfigAdminService.", e);
        }
        return stub;
    }
    ...
    public static WorkflowAdminServiceStub getWorkflowAdminService(Server server)
        ...
        IdentityServer identityServer = new IdentityServer(server);
        try {
            String serviceURL = identityServer.getHTTPSServerURL() + "/services/WorkflowAdminService";
            stub = new WorkflowAdminServiceStub(serviceURL);
            doServiceAuthenticate(identityServer, stub._getServiceClient());
        } catch (Exception e) {
            throw new CarbonSolutionException("Error occurred while getWorkflowAdminService.", e);
        }
        return stub;
    }
    ...
    public static UserAdminStub getUserAdminService(Server server)
        ...
        IdentityServer identityServer = new IdentityServer(server);
        try {
            String serviceURL = identityServer.getHTTPSServerURL() + "/services/UserAdmin";
            stub = new UserAdminStub(serviceURL);
            doServiceAuthenticate(identityServer, stub._getServiceClient());
        } catch (Exception e) {
            throw new CarbonSolutionException("Error occurred while getUserAdminService.", e);
        }
        return stub;
    }
    ...
    public static EntitlementPolicyAdminServiceStub getEntitlementPolicyAdminService(Server server)
        ...
        IdentityServer identityServer = new IdentityServer(server);
        try {
            String serviceURL = identityServer.getHTTPSServerURL() + "/services/EntitlementPolicyAdminService";
            stub = new EntitlementPolicyAdminServiceStub(serviceURL);
            doServiceAuthenticate(identityServer, stub._getServiceClient());
        } catch (Exception e) {
            throw new CarbonSolutionException("Error occurred while getEntitlementPolicyAdminService.", e);
        }
        return stub;
    }
